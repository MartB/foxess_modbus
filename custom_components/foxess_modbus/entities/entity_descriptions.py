...
def _version_entities() -> Iterable[EntityFactory]:
    ...
    yield _manager_version(
        address=[
            ...
            ModbusAddressSpec(holding=36003, models=Inv.H1_G2 | Inv.H3_PRO),
        ],
        is_hex=True,
    )
...
def _pv_entities() -> Iterable[EntityFactory]:
    ...
    yield _pv_voltage(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39070], models=Inv.H1_G2 | Inv.H3_PRO),
        ],
        name="PV1 Voltage",
    )
    yield _pv_current(
    ...
    yield _pv_current(
        key="pv1_current",
        addresses=[
            ModbusAddressesSpec(holding=[39071], models=Inv.H1_G2 | Inv.H3_PRO),
        ],
        name="PV1 Current",
        scale=0.01,
    )
    ...
    yield _pv_voltage(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39072], models=Inv.H1_G2 | Inv.H3_PRO),
        ],
        name="PV2 Voltage",
    )
    yield _pv_current(
    ...
    yield _pv_current(
        key="pv2_current",
        addresses=[
            ModbusAddressesSpec(holding=[39073], models=Inv.H1_G2 | Inv.H3_PRO),
        ],
        name="PV2 Current",
        scale=0.01,
    )
    ...
    yield _pv_voltage(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39076], models=Inv.H3_PRO),
        ],
        name="PV4 Voltage",
    )
    yield _pv_current(
