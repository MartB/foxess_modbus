...
from .modbus_inverter_state_sensor import H3_INVERTER_STATES
...
BMS_CONNECT_STATE_ADDRESS = [
    ...
    ModbusAddressSpec(holding=37002, models=Inv.KH_133 | Inv.EVO),
...
def _version_entities() -> Iterable[EntityFactory]:
    ...
    # eventually be matched on protocol version rather than on inferred inverter model
    yield ModbusProtocolVersionSensorDescription(
        key="protocol_version",
        addresses=[
            ModbusAddressesSpec(holding=[39001, 39000], models=Inv.H3_PRO_SET | Inv.H3_SMART),
        ],
...
def _identity_entities() -> Iterable[EntityFactory]:
    ...
    def _serial(
        ...
        chars_per_register: int,
        device: SubDevice | None = None,
    ) -> EntityFactory:
        if device is not None:
            assign_device(key, device)
    ...
    def _module_count(addresses: list[ModbusAddressesSpec]) -> EntityFactory:
        assign_device("battery_module_count", BATTERY)
        return ModbusSensorDescription(
    ...
    yield _module_count([ModbusAddressesSpec(holding=[31136], models=Inv.H3_SET)])
...
def _pv_entities() -> Iterable[EntityFactory]:
    ...
    yield _pv_power(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39330, 39329], models=Inv.H3_193),
        ],
        name="PV1 Power",
    )
    ...
    yield _pv_power(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39334, 39333], models=Inv.H3_193),
        ],
        name="PV2 Power",
    )
    yield _pv_energy_total(
    ...
    yield _pv_voltage(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39074], models=Inv.KH_133 | Inv.H3_PRO_HW | Inv.H3_SMART | Inv.EVO),
        ],
        name="PV3 Voltage",
    )
    yield _pv_current(
    ...
    yield _pv_current(
        key="pv3_current",
        addresses=[
            ModbusAddressesSpec(holding=[39075], models=Inv.KH_133 | Inv.H3_PRO_HW | Inv.H3_SMART | Inv.EVO),
        ],
        name="PV3 Current",
        scale=0.01,
    )
    yield _pv_power(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39284, 39283], models=Inv.H3_PRO_HW | Inv.H3_SMART | Inv.EVO),
        ],
        name="PV3 Power",
    )
    yield _pv_energy_total(
        ...
        models=[
            EntitySpec(
                register_types=[RegisterType.INPUT, RegisterType.HOLDING],
                models=Inv.KH_SET | Inv.H3_PRO_HW | Inv.H3_SMART,
            ),
        ],
    ...
    yield _pv_voltage(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39076], models=Inv.KH_133 | Inv.H3_PRO_HW | Inv.H3_SMART),
        ],
        name="PV4 Voltage",
    )
    yield _pv_current(
    ...
    yield _pv_current(
        key="pv4_current",
        addresses=[
            ModbusAddressesSpec(holding=[39077], models=Inv.KH_133 | Inv.H3_PRO_HW | Inv.H3_SMART),
        ],
        name="PV4 Current",
        scale=0.01,
    )
    yield _pv_power(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39286, 39285], models=Inv.KH_133 | Inv.H3_PRO_HW | Inv.H3_SMART),
        ],
        name="PV4 Power",
    )
    yield _pv_energy_total(
    ...
    yield _pv_voltage(
        key="pv5_voltage",
        addresses=[
            ModbusAddressesSpec(holding=[39078], models=Inv.H3_PRO_HW),
        ],
        name="PV5 Voltage",
    )
    yield _pv_current(
        key="pv5_current",
        addresses=[
            ModbusAddressesSpec(holding=[39079], models=Inv.H3_PRO_HW),
        ],
        name="PV5 Current",
        scale=0.01,
    )
    yield _pv_power(
        key="pv5_power",
        addresses=[
            ModbusAddressesSpec(holding=[39288, 39287], models=Inv.H3_PRO_HW),
        ],
        name="PV5 Power",
    )
    yield _pv_energy_total(
    ...
    yield _pv_voltage(
        key="pv6_voltage",
        addresses=[
            ModbusAddressesSpec(holding=[39080], models=Inv.H3_PRO_HW),
        ],
        name="PV6 Voltage",
    )
    yield _pv_current(
        key="pv6_current",
        addresses=[
            ModbusAddressesSpec(holding=[39081], models=Inv.H3_PRO_HW),
        ],
        name="PV6 Current",
        scale=0.01,
    )
    yield _pv_power(
        key="pv6_power",
        addresses=[
            ModbusAddressesSpec(holding=[39290, 39289], models=Inv.H3_PRO_HW),
        ],
        name="PV6 Power",
    )
    yield _pv_energy_total(
    ...
    yield ModbusLambdaSensorDescription(
        ...
        models=[
            EntitySpec(
                register_types=[RegisterType.INPUT, RegisterType.HOLDING],
                models=Inv.ALL & ~(Inv.KH_SET | Inv.H3_PRO_HW | Inv.H3_SMART | Inv.EVO),
            ),
        ],
    ...
    yield ModbusLambdaSensorDescription(
        ...
        sources=["pv1_power", "pv2_power", "pv3_power"],
        method=sum,
        name="PV Power",
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
...
def _h3_current_voltage_power_entities() -> Iterable[EntityFactory]:
    def _available_power(key: str, name: str, addresses: list[int]) -> EntityFactory:
        return ModbusSensorDescription(
            key=key,
            addresses=[ModbusAddressesSpec(holding=addresses, models=Inv.H3_PRO_SET | Inv.H3_SMART)],
            entity_registry_enabled_default=False,
            name=name,
            device_class=SensorDeviceClass.POWER,
            state_class=SensorStateClass.MEASUREMENT,
    ...
    yield _available_power("available_import_power", "Available Import Power", [39276, 39275])
    yield _available_power("available_export_power", "Available Export Power", [39278, 39277])
    ...
    yield _grid_voltage(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39123], models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO),
        ],
    )
    yield _grid_voltage(
        "S",
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39124], models=Inv.H3_PRO_SET | Inv.H3_SMART),
        ],
    )
    yield _grid_voltage(
        "T",
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39125], models=Inv.H3_PRO_SET | Inv.H3_SMART),
        ],
    )

    def _inv_voltage(phase: str, addresses: list[ModbusAddressesSpec]) -> EntityFactory:
        return ModbusSensorDescription(
            key=f"inv_voltage_{phase}",
            addresses=addresses,
            entity_registry_enabled_default=False,
            name=f"Inverter Voltage {phase}",
            device_class=SensorDeviceClass.VOLTAGE,
            state_class=SensorStateClass.MEASUREMENT,
            native_unit_of_measurement="V",
            scale=0.1,
    ...
    for phase, address in (("R", 31052), ("S", 31053), ("T", 31054)):
        yield _inv_voltage(phase, addresses=[ModbusAddressesSpec(holding=[address], models=Inv.H3_SET)])
    ...
    # Pro-map Inverter Current (spec V1.05.03.00 #154-156), yielded before the legacy set below so that it
    # wins the shared unique_id for H3 >= 1.93, which matches both
    yield from _inv_current_set(
        r_addresses=[ModbusAddressesSpec(holding=[39127, 39126], models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO)],
        s_addresses=[ModbusAddressesSpec(holding=[39129, 39128], models=Inv.H3_PRO_SET | Inv.H3_SMART)],
        t_addresses=[ModbusAddressesSpec(holding=[39131, 39130], models=Inv.H3_PRO_SET | Inv.H3_SMART)],
        scale=0.001,
    )
    ...
    yield _inv_power(
        phase=None,
        addresses=[
            ModbusAddressesSpec(holding=[31125, 31124], models=Inv.H3_180),
        ],
        scale=0.001,
    )
    yield _inv_power(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39249, 39248], models=Inv.H3_PRO_SET | Inv.H3_SMART),
        ],
        scale=0.001,
    )
    yield _inv_power(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39251, 39250], models=Inv.H3_PRO_SET | Inv.H3_SMART),
        ],
        scale=0.001,
    )
    yield _inv_power(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39253, 39252], models=Inv.H3_PRO_SET | Inv.H3_SMART),
        ],
        scale=0.001,
    )
    ...
    yield ModbusSensorDescription(
        key="non_self_ac_pwr",
        addresses=[
            ModbusAddressesSpec(holding=[31150, 31149], models=Inv.H3_180),
        ],
        name="Parallel System AC Power",
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        native_unit_of_measurement="kW",
        icon="mdi:meter-electric-outline",
    ...
    yield _inv_power_reactive(
        phase="T", addresses=[ModbusAddressesSpec(holding=[39261, 39260], models=Inv.H3_PRO_SET | Inv.H3_SMART)]
    )
    ...
    yield _inv_power_apparent(
        phase=None,
        addresses=[
            ModbusAddressesSpec(holding=[39271, 39270], models=Inv.H3_PRO_SET | Inv.H3_SMART),
            ModbusAddressesSpec(holding=[31056, 31055], models=Inv.H3_180),
        ],
    )
    yield _inv_power_apparent(
        phase="R",
        addresses=[
            ModbusAddressesSpec(holding=[39265, 39264], models=Inv.H3_PRO_SET | Inv.H3_SMART),
            ModbusAddressesSpec(holding=[31057], models=Inv.H3_180),
        ],
    )
    yield _inv_power_apparent(
        phase="S",
        addresses=[
            ModbusAddressesSpec(holding=[39267, 39266], models=Inv.H3_PRO_SET | Inv.H3_SMART),
            ModbusAddressesSpec(holding=[31058], models=Inv.H3_180),
        ],
    )
    yield _inv_power_apparent(
        phase="T",
        addresses=[
            ModbusAddressesSpec(holding=[39269, 39268], models=Inv.H3_PRO_SET | Inv.H3_SMART),
            ModbusAddressesSpec(holding=[31059], models=Inv.H3_180),
        ],
    )
    ...
    # EVO is single-phase, so it only appears on R
    for phase, h3, pro, extra in (
        ("R", 31016, 39201, Inv.EVO),
        ("S", 31017, 39202, Inv(0)),
        ("T", 31018, 39203, Inv(0)),
    ):
        yield _eps_rvolt(
            phase,
            addresses=[
                ModbusAddressesSpec(holding=[h3], models=Inv.H3_180),
                ModbusAddressesSpec(holding=[pro], models=Inv.H3_PRO_SET | Inv.H3_SMART | extra),
            ],
        )

    def _eps_rcurrent(phase: str, scale: float, addresses: list[ModbusAddressesSpec]) -> EntityFactory:
        return ModbusSensorDescription(
    ...
    # Two per phase, as the Pro registers are a 32-bit pair with a different scale to the legacy H3 one.
    # EVO is single-phase, so it only appears on R
    for phase, h3_reg, pro_pair, extra in (
        ("R", 31019, [39205, 39204], Inv.EVO),
        ("S", 31020, [39207, 39206], Inv(0)),
        ("T", 31021, [39209, 39208], Inv(0)),
    ):
        yield _eps_rcurrent(
            phase,
            scale=0.001,
            addresses=[ModbusAddressesSpec(holding=pro_pair, models=Inv.H3_PRO_SET | Inv.H3_SMART | extra)],
        )
        yield _eps_rcurrent(phase, scale=0.1, addresses=[ModbusAddressesSpec(holding=[h3_reg], models=Inv.H3_SET)])

    def _eps_power(phase: str | None, addresses: list[ModbusAddressesSpec]) -> EntityFactory:
        key_suffix = f"_{phase}" if phase is not None else ""
        name_suffix = f" {phase}" if phase is not None else ""

        return ModbusSensorDescription(
            key=f"eps_power{key_suffix}",
            addresses=addresses,
            entity_registry_enabled_default=False,
            name=f"EPS Power{name_suffix}",
            device_class=SensorDeviceClass.POWER,
            state_class=SensorStateClass.MEASUREMENT,
            native_unit_of_measurement="kW",
            icon="mdi:power-socket",
    ...
    yield _eps_power(
        phase=None,
        addresses=[
            ModbusAddressesSpec(holding=[31138, 31137], models=Inv.H3_SET),
    ...
    yield from _grid_ct(
        ...
        scale=0.0001,  # 0.1W
        addresses=[
            ModbusAddressesSpec(holding=[38815, 38814], models=Inv.H3_PRO_SET | Inv.H3_SMART),
        ],
    )
    yield from _grid_ct(
        phase=None,
        scale=0.001,
        addresses=[
            ModbusAddressesSpec(holding=[31066, 31065], models=Inv.H3_SET),
        ],
    )
    yield from _grid_ct(
        "R",
        scale=0.0001,
        addresses=[
            ModbusAddressesSpec(holding=[38817, 38816], models=Inv.H3_PRO_SET | Inv.H3_SMART),
        ],
    )
    yield from _grid_ct(
        "R",
        scale=0.001,
        addresses=[
            ModbusAddressesSpec(holding=[31068, 31067], models=Inv.H3_SET),
        ],
    )
    yield from _grid_ct(
        "S",
        scale=0.0001,
        addresses=[
            ModbusAddressesSpec(holding=[38819, 38818], models=Inv.H3_PRO_SET | Inv.H3_SMART),
        ],
    )
    yield from _grid_ct(
        "S",
        scale=0.001,
        addresses=[
            ModbusAddressesSpec(holding=[31070, 31069], models=Inv.H3_SET),
        ],
    )
    yield from _grid_ct(
        "T",
        scale=0.0001,
        addresses=[
            ModbusAddressesSpec(holding=[38821, 38820], models=Inv.H3_PRO_SET | Inv.H3_SMART),
        ],
    )
    yield from _grid_ct(
        "T",
        scale=0.001,
        addresses=[
            ModbusAddressesSpec(holding=[31072, 31071], models=Inv.H3_SET),
        ],
    )
    ...
    yield from _grid_ct_reactive_set(
        addresses=[ModbusAddressesSpec(holding=[31074, 31073], models=Inv.H3_180)],
        r_addresses=[ModbusAddressesSpec(holding=[31076, 31075], models=Inv.H3_180)],
        s_addresses=[ModbusAddressesSpec(holding=[31078, 31077], models=Inv.H3_180)],
        t_addresses=[ModbusAddressesSpec(holding=[31080, 31079], models=Inv.H3_180)],
        scale=0.001,
    )
    ...
    yield from _grid_ct_power_factor_set(
        ...
        scale=0.00001,  # modbus scale: 1000
    )
    yield from _grid_ct_power_factor_set(
        addresses=[ModbusAddressesSpec(holding=[31081], models=Inv.H3_180)],
        r_addresses=[ModbusAddressesSpec(holding=[31082], models=Inv.H3_180)],
        s_addresses=[ModbusAddressesSpec(holding=[31083], models=Inv.H3_180)],
        t_addresses=[ModbusAddressesSpec(holding=[31084], models=Inv.H3_180)],
        scale=0.01,  # modbus scale: 100
    )
    ...
    yield _ct2_meter(
        phase=None, scale=0.001, addresses=[ModbusAddressesSpec(holding=[31108, 31107], models=Inv.H3_180)]
    )
    for phase, h3_pair, pro_pair in (
        ("R", [31110, 31109], [38917, 38916]),
        ("S", [31112, 31111], [38919, 38918]),
        ("T", [31114, 31113], [38921, 38920]),
    ):
        yield _ct2_meter(
            phase, scale=0.0001, addresses=[ModbusAddressesSpec(holding=pro_pair, models=Inv.H3_PRO_SET | Inv.H3_SMART)]
        )
        yield _ct2_meter(phase, scale=0.001, addresses=[ModbusAddressesSpec(holding=h3_pair, models=Inv.H3_180)])
    ...
    yield _load_power(
        "R",
        addresses=[
            ModbusAddressesSpec(holding=[31129, 31128], models=Inv.H3_180),
    ...
    yield _load_power(
        "S",
        addresses=[
            ModbusAddressesSpec(holding=[31131, 31130], models=Inv.H3_180),
    ...
    yield _load_power(
        "T",
        addresses=[
            ModbusAddressesSpec(holding=[31133, 31132], models=Inv.H3_180),
    ...
    yield _load_power(
        phase=None,
        addresses=[
            ModbusAddressesSpec(holding=[31127, 31126], models=Inv.H3_180),
...
def _inverter_entities() -> Iterable[EntityFactory]:
    ...
    yield _invbatvolt(
        index=1, addresses=[ModbusAddressesSpec(holding=[39227], models=Inv.H3_PRO_HW | Inv.H3_SMART | Inv.EVO)]
    )
    yield _invbatvolt(index=2, addresses=[ModbusAddressesSpec(holding=[39232], models=Inv.H3_PRO_HW | Inv.H3_SMART)])
    ...
    yield _invbatcurrent(
        index=1,
        scale=0.001,
        addresses=[ModbusAddressesSpec(holding=[39229, 39228], models=Inv.H3_PRO_HW | Inv.H3_SMART | Inv.EVO)],
    )
    yield _invbatcurrent(
        index=2,
        scale=0.001,
    ...
    yield from _invbatpower(
        index=1,
        addresses=[
            ModbusAddressesSpec(holding=[39231, 39230], models=Inv.H3_PRO_HW | Inv.H3_SMART | Inv.EVO),
        ],
    )
    yield from _invbatpower(
        index=2,
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39236, 39235], models=Inv.H3_PRO_HW | Inv.H3_SMART),
        ],
    )
    ...
    grid_phase_freq_address_map = {
        "R": [
            ...
            ModbusAddressesSpec(
                holding=[31009],
                models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2_SET | Inv.KH_PRE133 | Inv.KH_133,
            ),
        ...
        "S": [
            ModbusAddressesSpec(holding=[31085], models=Inv.H3_180),
        ],
        "T": [
            ModbusAddressesSpec(holding=[31086], models=Inv.H3_180),
        ],
    }

    for phase, addresses in grid_phase_freq_address_map.items():
        if addresses:
            yield ModbusSensorDescription(
                key=f"{phase.lower()}freq",
                addresses=addresses,
                entity_registry_enabled_default=False,
                name=f"Grid {phase} Frequency",
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39218], models=Inv.EVO),
        ],
        entity_registry_enabled_default=False,
        name="EPS Frequency",
        device_class=SensorDeviceClass.FREQUENCY,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39142], models=Inv.EVO),
        ],
        name="Ambient Temp",
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    for key in ("bms_charge_rate", "bms_discharge_rate", "bms_cycle_count", "bms_watthours_total"):
        assign_device(key, BATTERY)
    ...
    yield ModbusInverterStateSensorDescription(
        key="inverter_state",
        address=[
            ModbusAddressSpec(holding=31041, models=Inv.H3_SET),
        ],
        name="Inverter State",
        states=H3_INVERTER_STATES,
    )
    yield ModbusSensorDescription(
        key="state_code",
        addresses=[
    ...
    yield _battery_charge_total(
        addresses=[
            ModbusAddressesSpec(
                holding=[39606, 39605], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO
            ),
        ],
        scale=0.01,
    )
    ...
    yield _battery_charge_today(
        addresses=[
            ModbusAddressesSpec(
                holding=[39608, 39607], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO
            ),
        ],
        scale=0.01,
    )
    ...
    yield _battery_discharge_total(
        addresses=[
            ModbusAddressesSpec(
                holding=[39610, 39609], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO
            ),
        ],
        scale=0.01,
    )
    ...
    yield _battery_discharge_today(
        addresses=[
            ModbusAddressesSpec(
                holding=[39612, 39611], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO
            ),
        ],
        scale=0.01,
    )
    ...
    yield _feed_in_energy_total(
        addresses=[
            ModbusAddressesSpec(
                holding=[39614, 39613], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO
            ),
        ],
        scale=0.01,
    )
    ...
    yield _feed_in_energy_today(
        addresses=[
            ModbusAddressesSpec(
                holding=[39616, 39615], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO
            ),
        ],
        scale=0.01,
    )
    ...
    yield _grid_consumption_energy_total(
        addresses=[
            ModbusAddressesSpec(
                holding=[39618, 39617], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO
            ),
        ],
        scale=0.01,
    )
    ...
    def _system_soc(addresses: list[ModbusAddressesSpec]) -> EntityFactory:
        assign_device("system_soc", BATTERY)
    ...
    # Pro hardware and Smart had no System SoC before. H3 >= 1.93 is excluded because 39423 answers
    # IllegalAddress there, so it falls back to the legacy spec below
    yield _system_soc(
        addresses=[
            ModbusAddressesSpec(holding=[39423], models=Inv.H3_PRO_HW | Inv.H3_SMART),
        ]
    )
    yield _system_soc(
        addresses=[
            ModbusAddressesSpec(holding=[31141], models=Inv.H3_180),
        ]
    )
    ...
    yield _grid_consumption_energy_today(
        addresses=[
            ModbusAddressesSpec(
                holding=[39620, 39619], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO
            ),
        ],
        scale=0.01,
    )
    ...
    yield _total_yield_total(
        addresses=[
            ModbusAddressesSpec(
                holding=[39622, 39621], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO
            ),
        ],
        scale=0.01,
    )
    ...
    yield _total_yield_today(
        addresses=[
            ModbusAddressesSpec(
                holding=[39624, 39623], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO
            ),
        ],
        scale=0.01,
    )
    ...
    yield _input_energy_total(
        addresses=[
            ModbusAddressesSpec(
                holding=[39626, 39625], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO
            ),
        ],
        scale=0.01,
    )
    ...
    yield _input_energy_today(
        addresses=[
            ModbusAddressesSpec(
                holding=[39628, 39627], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO
            ),
        ],
        scale=0.01,
    )
    ...
    yield _load_power_total(
        addresses=[
            ModbusAddressesSpec(
                holding=[39630, 39629], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO
            ),
        ],
        scale=0.01,
    )
    ...
    yield _load_energy_today(
        addresses=[
            ModbusAddressesSpec(
                holding=[39632, 39631], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO
            ),
        ],
        scale=0.01,
    )
...
def _bms_entities() -> Iterable[EntityFactory]:
    def _inner(
        ...
        yield ModbusBatterySensorDescription(
            key=f"bms_pwr_limit_discharge{key_suffix}",
            addresses=bms_pwr_limit_discharge,
            bms_connect_state_address=BMS_CONNECT_STATE_ADDRESS,
        ...
        yield ModbusBatterySensorDescription(
            key=f"bms_pwr_limit_charge{key_suffix}",
            addresses=bms_pwr_limit_charge,
            bms_connect_state_address=BMS_CONNECT_STATE_ADDRESS,
            entity_registry_enabled_default=True,
    ...
    # Per-BMS-unit batteries, which only real Pro hardware has - hence H3_PRO_HW rather than H3_PRO_SET
    yield from on_device(
        BMS[1],
        _inner(
            index=1,
            bms_connect_state_address=[ModbusAddressSpec(holding=37002, models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            batvolt=[ModbusAddressesSpec(holding=[37609], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            bat_current=[ModbusAddressesSpec(holding=[37610], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            battery_soc=[ModbusAddressesSpec(holding=[37612], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            ...
            battery_temp=[ModbusAddressesSpec(holding=[37611], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            bms_cell_temp_high=[ModbusAddressesSpec(holding=[37617], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            bms_cell_temp_low=[ModbusAddressesSpec(holding=[37618], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            bms_cell_mv_high=[ModbusAddressesSpec(holding=[37619], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            bms_cell_mv_low=[ModbusAddressesSpec(holding=[37620], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            bms_kwh_remaining=[ModbusAddressesSpec(holding=[37632], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            bms_pwr_limit_discharge=[],
            bms_pwr_limit_charge=[],
        ),
    )
    yield from on_device(
        ...
        _inner(
            index=2,
            bms_connect_state_address=[ModbusAddressSpec(holding=37700, models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            batvolt=[ModbusAddressesSpec(holding=[38307], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            bat_current=[ModbusAddressesSpec(holding=[38308], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            battery_soc=[ModbusAddressesSpec(holding=[38310], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            # Added in H3_PRO v1.25, which hasn't been released yet.
            # See https://github.com/nathanmarlor/foxess_modbus/pull/775#issuecomment-2656447502
            battery_soh=[ModbusAddressesSpec(holding=[38322], models=Inv.H3_SMART)],
            battery_temp=[ModbusAddressesSpec(holding=[38309], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            bms_cell_temp_high=[ModbusAddressesSpec(holding=[38315], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            bms_cell_temp_low=[ModbusAddressesSpec(holding=[38316], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            bms_cell_mv_high=[ModbusAddressesSpec(holding=[38317], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            bms_cell_mv_low=[ModbusAddressesSpec(holding=[38318], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            bms_kwh_remaining=[ModbusAddressesSpec(holding=[38330], models=Inv.H3_PRO_HW | Inv.H3_SMART)],
            bms_pwr_limit_discharge=[],
            bms_pwr_limit_charge=[],
        ),
    )
...
def _configuration_entities() -> Iterable[EntityFactory]:
    ...
    yield ModbusWorkModeSelectDescription(
        key="work_mode",
        address=[
            # H3 >= 1.93 is in both H3_SET and H3_PRO_SET, and uses the Pro work mode register above
            ModbusAddressSpec(holding=41000, models=Inv.H1_G2_SET | Inv.H3_SET & ~Inv.AIO_H3_PRE101 & ~Inv.H3_193),
        ],
        name="Work Mode",
    ...
    yield ModbusSelectDescription(
        key="inverter_on_off",
        address=[
            ModbusAddressSpec(holding=41014, models=Inv.H3_SET),
        ],
    ...
    yield ModbusSelectDescription(
        key="mppt_switchoff",
        address=[
            ModbusAddressSpec(holding=44030, models=Inv.H3_180),
        ],
        name="MPPT Switch-off",
        icon="mdi:solar-power",
        entity_category=EntityCategory.CONFIG,
        options_map={
            0: "Both Enabled",
    ...
    yield ModbusNumberDescription(
        ...
        addresses=[
            ...
            ModbusAddressSpec(holding=46607, models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO),
        ],
        name="Max Charge Current",
        mode=NumberMode.BOX,
    ...
    yield ModbusNumberDescription(
        ...
        addresses=[
            ...
            ModbusAddressSpec(holding=46608, models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO),
        ],
        name="Max Discharge Current",
        mode=NumberMode.BOX,
        device_class=NumberDeviceClass.CURRENT,
    ...
    yield ModbusNumberDescription(
        ...
        addresses=[
            ...
            ModbusAddressSpec(holding=46609, models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO),
        ],
        name="Min SoC",
        mode=NumberMode.BOX,
        native_min_value=10,
    ...
    yield ModbusNumberDescription(
        ...
        addresses=[
            ...
            ModbusAddressSpec(holding=46610, models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO),
        ],
        name="Max SoC",
        mode=NumberMode.BOX,
        native_min_value=10,
    ...
    yield ModbusNumberDescription(
        ...
        addresses=[
            ...
            ModbusAddressSpec(holding=46611, models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO),
        ],
        name="Min SoC (On Grid)",
        mode=NumberMode.BOX,
        native_min_value=10,
    ...
    yield ModbusNumberDescription(
        key="export_limit",
        addresses=[
            ModbusAddressesSpec(holding=[41013, 41012], models=Inv.H3_180),
            ModbusAddressesSpec(holding=[46617, 46616], models=Inv.H3_193),
        ],
        name="Export Limit",
    ...
    yield ModbusNumberDescription(
        ...
        addresses=[
            ModbusAddressesSpec(holding=[46502, 46501], models=Inv.H3_193),
        ],
