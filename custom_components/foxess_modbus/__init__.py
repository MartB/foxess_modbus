    ...
    if version == 2:
        ...
        if energy_manager.data is not None:
            ...
            for energy_source in energy_data.get("energy_sources", []):
                # A grid source used to nest its import and export in flow_from/flow_to lists, whose
                # optional keys had to be filled in. It carries them itself now, and defaults each one
